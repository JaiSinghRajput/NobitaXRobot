...
from nobita.helper.pyro_progress import progress_for_pyrogram
from nobita.helper.tools import get_random_string
...
def get_subname(lang, url, ext):
    ...
    if scheme_removed.find("/") == -1 or not get_base_name(
        ...
        return f"[{lang.upper()}] nobitaSub{get_random_string(4)}.{ext}"
