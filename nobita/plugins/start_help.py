...
from nobita import BOT_NAME, BOT_USERNAME, HELPABLE, app
from nobita.helper import bot_sys_stats, paginate_modules
...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton(
                text="Source Code 🛠",
                url="https://github.com/jaisingh007/NobitaXRobot",
            ),
        ],
        [
            InlineKeyboardButton(
            ...
            InlineKeyboardButton(text="Dev 👨", url="https://t.me/jaisingh007"),
        ],
        [
            InlineKeyboardButton(
    ...
    if ctx.chat.type.value != "private":
        ...
        try:
            return await ctx.reply_photo(
                photo="https://img.nobiweb.eu.org/file/90e9a448bc2f8b055b762.jpg",
