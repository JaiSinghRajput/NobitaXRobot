...
# Copyright (C) 2021 - 2022 Jayant Hegde Kageri <https://github.com/jaisingh007>
...
from nobita.vars import LOG_CHANNEL
...
async def handle_error(
    ...
    if isinstance(m, pyrogram.types.Message):
        with contextlib.suppress(Exception):
            try:
                await m.reply_photo(
                    "https://img.nobiweb.eu.org/file/3c9162b242567ae25d5af.jpg",
