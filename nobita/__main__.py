...
from nobita import BOT_NAME, BOT_USERNAME, HELPABLE, UBOT_NAME, app, scheduler, get_event_loop
from nobita.plugins import ALL_MODULES
from nobita.plugins.web_scraper import web
from nobita.vars import SUDO, USER_SESSION
...
async def start_bot():
    for module in ALL_MODULES:
        imported_module = importlib.import_module(f"nobita.plugins.{module}")
